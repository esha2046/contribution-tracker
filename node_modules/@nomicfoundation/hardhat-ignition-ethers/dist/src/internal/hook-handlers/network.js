...
export default async () => {
    const handlers = {
        async newConnection(context, next) {
            ...
            connection.ignition = new EthersIgnitionHelperImpl(context.config, context.artifacts, connection, context.interruptions, context.hooks, context.config.ignition);
            return connection;
        },
    };
    return handlers;
